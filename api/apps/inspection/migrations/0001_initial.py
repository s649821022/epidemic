    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(max_length=64, verbose_name='检查地点')),
                ('result', models.CharField(max_length=2, verbose_name='检查结果')),
                ('detail', models.CharField(max_length=125, verbose_name='检查详情')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inspection', to=settings.AUTH_USER_MODEL, verbose_name='记录员')),
            ],
            options={
                'db_table': 'inspection',
            },
